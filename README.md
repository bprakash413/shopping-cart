...
* When you have completed the assignment, you need to  push your code to this repository and [mark the assignment as completed by clicking here](https://app.snapcode.review/submission_links/cd6eb725-d3dc-4ca6-827d-6bac8c63e4b1).
...
`com.shoppingcart` — `ShoppingCart`, `CartItem`, `CartSummary`, `PriceClient`, `HttpPriceClient`
...
- `CartSummaryTest` — subtotal, tax, total, and rounding
...
- **What AI was used for:** writing the `HttpPriceClientTest` test cases.
- **How much code AI wrote:** test methods of `HttpPriceClientTest`
